...
class Article(models.Model):
    ...
    article_friendly_name = models.CharField(max_length=254, null=True, blank=True)
    article_image = models.URLField(max_length=254, null =True, blank =True)
    article_content = models.TextField( max_length=254, null=True, blank =True)
...
class Snippet(models.Model):
    ...
    snippet_friendly_name = models.CharField(max_length=254, null=True, blank=True) 
...
class ClassifiedAdds(models.Model):
    ...
    classified_friendly_name = models.CharField(max_length=254, null=True, blank=True) 
    classified_detail = models.TextField( max_length=2000, null=True,blank=True)
