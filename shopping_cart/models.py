...
class ShoppingCartModel(models.Model):
    ...
    cart_price_paid = models.DecimalField(
        max_digits=5, decimal_places=2, default=0.00)

    cart_film_genre = models.ForeignKey(
        Genre, default=1, on_delete=models.SET_DEFAULT)
    ...
    cart_film_friendly_title = models.CharField(
        max_length=254, null=True, blank=True)

    cart_film_box_cover_url = models.URLField(max_length=254, default="")

    cart_film_description = models.TextField(
        max_length=2000, null=True, blank=True)

    cart_film_price = models.DecimalField(
        max_digits=5, decimal_places=2, default=9.99)
    cart_film_product_discount = models.DecimalField(
    ...
    cart_film_clip_link = models.URLField(
        max_length=254, null=True, blank=True)
